...
download.file(fileUrl, destfile = paste0("~/Projects/datasciencecoursera/Reproducible_Research/Project-2", '/repdata%2Fdata%2FStormData.csv.bz2'))
...
```{r EconConsequences}
library(reshape)
econ_consequences <- reshape2::melt(totalCostDT, id.vars="EVTYPE", variable.name = "Damage_Type")
